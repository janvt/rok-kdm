...
class CommanderNames
{
    const UID_ALEX = 'alex';
    const UID_ARTY = 'arty';
    const UID_AETH = 'aeth';
    const UID_ATT = 'att';
    const UID_BARCA = 'barca';
    const UID_CC = 'cc';
    const UID_CHAN = 'chan';
    const UID_CH = 'ch';
    const UID_CJ = 'cj';
    ...
    const ALL = [
        ...
        self::UID_ATT => 'Attila',
        self::UID_BARCA => 'Hannibal Barca',
        self::UID_CC => 'Cao Cao',
        self::UID_CHAN => 'Chandragupta',
        self::UID_CH => 'Charlemagne',
        self::UID_CJ => 'Cheok Jun-gyeong',
        self::UID_CM => 'Charles Martel',
        self::UID_CON => 'Constantine',
        self::UID_CY => 'Cyrus the Great',
        self::UID_ED => 'Edward',
        self::UID_ELCID => 'El Cid',
        self::UID_FRED => 'Frederick I',
        self::UID_GUAN => 'Guan Yu',
        self::UID_HAR => 'Harald',
        self::UID_JAD => 'Jadwiga',
        self::UID_JC => 'Julius Caesar',
        self::UID_KHAN => 'Genghis Khan',
        self::UID_KJP => 'Pakal',
        self::UID_LEO => 'Leo',
        self::UID_LB => 'Lu Bu',
        self::UID_MEH => 'Mehmed II',
        self::UID_MINA => 'Minamoto',
        self::UID_MOC => 'Moctezuma I',
        self::UID_MULAN => 'Mulan',
        self::UID_NEBU => 'Nebuchadnezzar II',
        self::UID_R2 => 'Ramesses II',
        self::UID_RAG => 'Ragnar Lodbrok',
        ...
        self::UID_XY => 'Xiang Yu',
        self::UID_YSG => 'Yi Seong-Gye',
        self::UID_YSS => 'Yi Sun-sin',
        self::UID_ZENO => 'Zenobia',
    ];
}